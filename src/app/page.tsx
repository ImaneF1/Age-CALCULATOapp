...
export default function Home() {
  return (
    <div>
      ...
      <main className="flex flex-col gap-5 h-[400px] px-5 w-full absolute top-10 left-1/2 transform -translate-x-1/2">
        <div className="flex justify-between mb-2 items-baseline">
          <h2 className="text-white text-[26px] tracking-[10px] font-semibold">TODO</h2>
