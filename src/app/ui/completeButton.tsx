...
export default function CompleteButton({ isCompleted, modifyTask } : CompleteButtonProps ) {
    ...
    return (
        <>
            <div className={`rounded-full flex items-center justify-center ${isCompleted ? "bg-gradient-to-br from-cyan-300 to-purple-500" : "border border-gray-400"} w-[20px] h-[20px]`} onClick={() => modifyTask()}>
                {isCompleted && (
